 ...
 * @subpackage Run_The_SQL_Query/admin/partials
 */
?>

<div class="wrap">
	<h1>Run The SQL Query</h1>
	<?php wp_nonce_field( 'run_the_sql_query' ); ?>
	<p>
	<label>Table: </label>
	<?php
	...
	<div class="form-field">
		...
		<span><em>*Use with extreme caution, queries you run here can alter the database.</em></span>
	</div>
	<p>
		<input type="button" id="run_the_query_button" class="button button-primary" value="Run Query" />
	</p>
